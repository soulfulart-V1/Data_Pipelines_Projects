...
MCUNodeMCUEsp12E::MCUNodeMCUEsp12E(){
    ...
    this->device_class = "{temp,hum,sound}";
...
MCUNodeMCUEsp12E::getPhysicalDataJson(){
    ...
    payload_json.replace(payload_json.find("<stream_time>"), sizeof("<stream_time>")-1, this->stream_time);
